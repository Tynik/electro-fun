...
export const ChipIcon = (props: SvgIconOwnProps) => {
  return (
    <SvgIcon {...props}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.18 485.18" fill="currentColor">
        <g>
          <g>
            <path
              d="M483.94,338.09l-15.4-33.2c-2.2-4.8-7-7.8-12.2-7.8h-73.4v-19.6h36.1c7.4,0,13.5-6,13.5-13.5c0-7.4-6-13.5-13.5-13.5
